package de.gishmo.gwt.example.module0701.client;
 ...
 */
public class Module0701 implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    RootPanel.get().add(labelHeadline);
    ...
    htmlKurUndBo.getElement().setAttribute("style", "font-weight: bold;");
    RootPanel.get().add(htmlKurUndBo);
