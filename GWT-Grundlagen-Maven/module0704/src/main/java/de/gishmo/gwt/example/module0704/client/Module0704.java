 ...
 */
public class Module0704 implements EntryPoint {
  ...
  private void createDialogBox() {
    ...
    labelName.getElement().getStyle().setMarginTop(10, Unit.PX);
    labelName.setWidth("75px");
    hp01.add(labelName);
    searchName = new TextBox();
    searchName.setWidth("250px");
    searchName.getElement().getStyle().setMargin(5, Unit.PX);
    hp01.add(searchName);
    ...
    labelCity.getElement().getStyle().setMarginTop(10, Unit.PX);
    labelCity.setWidth("75px");
    hp02.add(labelCity);
    searchCity = new TextBox();
    searchCity.setWidth("250px");
    searchCity.getElement().getStyle().setMargin(5, Unit.PX);
    hp02.add(searchCity);
    
    HorizontalPanel hp03 = new HorizontalPanel();
    dialogVPanel.add(hp03);
    dialogVPanel.setCellHorizontalAlignment(hp03, HasHorizontalAlignment.ALIGN_RIGHT);
    
    final Button searchButton = new Button("Suchen");
    searchButton.getElement().getStyle().setMargin(5, Unit.PX);
    hp03.add(searchButton);

    final Button closeButton = new Button("Schliessen");
    closeButton.getElement().getStyle().setMargin(5, Unit.PX);
