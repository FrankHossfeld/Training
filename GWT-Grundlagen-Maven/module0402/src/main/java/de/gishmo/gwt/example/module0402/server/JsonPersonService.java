...
public class JsonPersonService extends HttpServlet {
  ...
  private void initList() {
    ...
    persons.put(new Long(1), person01);
    persons.put(new Long(2), person02);
    persons.put(new Long(3), person03);
    persons.put(new Long(4), person04);
    persons.put(new Long(5), person05);
    persons.put(new Long(6), person06);
    persons.put(new Long(7), person07);
    persons.put(new Long(8), person08);
    persons.put(new Long(9), person09);
    persons.put(new Long(10), person10);
  }
}