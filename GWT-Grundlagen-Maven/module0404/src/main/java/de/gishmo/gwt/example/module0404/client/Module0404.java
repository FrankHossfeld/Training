package de.gishmo.gwt.example.module0404.client;
 ...
 */
public class Module0404 implements EntryPoint {
  /**
   ...
   */
  private final DispatchAsync dispatchService = new StandardDispatchAsync(new DefaultExceptionHandler());
  ...
  public void onModuleLoad() {
    ...
    class MyHandler01 implements ClickHandler, KeyUpHandler {
      ...
      private void sendNameToServer() {
        ...
        dispatchService.execute(new GetPersonAction(id), 
                                new AsyncCallback<GetPersonResult>() {
          ...
          @Override
          public void onSuccess(GetPersonResult result) {
            dialogBox.setText("Remote Procedure Call");
            serverResponseLabel.removeStyleName("serverResponseLabelError");
            serverResponseLabel.setHTML("The name of the person you requested is: " + result.getPerson().getFirstName() + " " + result.getPerson().getName());
            dialogBox.center();
            closeButton.setFocus(true);
          }
        });
    ...
    class MyHandler02 implements ClickHandler, KeyUpHandler {
      ...
      private void sendNameToServer() {
        ...
        serverResponseLabel.setText("");
        dispatchService.execute(new GetAllPersonsAction(), new AsyncCallback<GetAllPersonsResult>() {
          ...
          @Override
          public void onSuccess(GetAllPersonsResult result) {
            dialogBox.setText("Remote Procedure Call");
            serverResponseLabel.removeStyleName("serverResponseLabelError");
            String html = "";
