package de.gishmo.gwt.example.module0902.client.ui.navigation;
...
import de.gishmo.gwt.example.module0902.client.events.SearchPersons;
import de.gishmo.gwt.example.module0902.client.events.SetNavigation;
...
public class NavigationPresenter
  ...
  private ListPlace createListPlace() {
    if (search == null) {
      ...
      return new ListPlace(search.getName(),
                           search.getCity());
    }
  }
  ...
  private SearchPlace createSearchPlace() {
    if (search == null) {
      ...
      return new SearchPlace(search.getName(),
                             search.getCity());
    }
  }
}
