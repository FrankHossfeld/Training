package de.gishmo.gwt.example.module0902.client.ui.list;
...
import de.gishmo.gwt.example.module0902.client.events.SetStatus;
import de.gishmo.gwt.example.module0902.client.resources.ApplicationConstants;
import de.gishmo.gwt.example.module0902.client.resources.ApplicationMessages;
...
public class ListPresenter
  ...
  public void doUpdate(Person object) {
    clientContext.getPlaceController()
                 .goTo(new DetailPlace(object.getId()));
  }
  ...
  private void searchPersons() {
    if (place != null) {
      if ((place.getSearchName() != null && place.getSearchName()
                                                 .length() > 0) || (place.getSearchCity() != null && place.getSearchCity()
                                                                                                          .length() > 0)) {
